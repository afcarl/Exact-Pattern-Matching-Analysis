...
For the DNA dataset, the fixed length text of 500000 was used for the input test. The pattern length was varied from the length of one character (i.e $A$) to the length of 100 characters $TCTGG...TCGAA$. Since Aho Corasick and Suffix Tree has occurrance z as part of their complexity, the occurance of the each different length of patterns in each input is know. This way, the algorithm performance subject to z can be observed. 
